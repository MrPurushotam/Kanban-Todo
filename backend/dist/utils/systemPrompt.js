...
exports.EnhancedWorkspaceController = exports.SystemPromptBuilder = void 0;
const geminiFxn_1 = require("./geminiFxn");
class SystemPromptBuilder {
    // Main system prompt with multiple protection layers
    static buildKanbanSystemPrompt(projectType = 'general', preferences = {}) {
  ...
  - EXACTLY 8-30 tasks in the array`;
    ...
    static getValidationRules(projectType, preferences) {
  ...
  ---`;
    ...
    static detectPromptInjection(userInput) {
    ...
    static buildFinalPrompt(projectDescription, projectType = 'general', preferences = {}) {
        // Security checks
...
class EnhancedWorkspaceController {
    static async generateWorkspace(req, res) {
        try {
            ...
            const result = await geminiFxn_1.ai.models.generateContent({
    ...
    static async generateWorkspaceData(description, projectType = 'general', preferences = {}) {
        try {
            const prompt = SystemPromptBuilder.buildFinalPrompt(description, projectType, preferences);
            const result = await geminiFxn_1.ai.models.generateContent({
                model: "gemini-2.0-flash",
    ...
    static validateAndParseResponse(responseText) {
        try {
            // Clean response
...
exports.EnhancedWorkspaceController = EnhancedWorkspaceController;
